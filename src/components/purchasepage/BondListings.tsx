...
const BondListings: FC = () => {
  const bonds: Bond[] = [{symbol: 'A', maturityDate: '15-01-24', couponRate: '4.00%', volume: '100m', cost: '20 USD', bondType: 'Installation Bond'}, {symbol: 'B', maturityDate: '15-07-23', couponRate: '6.00%', volume: '30m', cost: '40USD', bondType: 'Time Contract Bond'}, {symbol: 'C', maturityDate: '15-01-25', couponRate: '8.00%', volume: '80m', cost: '50USD', bondType: 'Callable Bond'}]
  ...
  return (
    <div>
      ...
      <div className='h-full flex flex-col items-center m-10'>{bonds.map((bond, index) => <BondListing bond={bond} index={index} key={bond.symbol} handleClick={handleClick}/>)}</div>
    </div>
  );
}
