...
const ServicesDisplay: FC = () => {
  ...
  return (
    <div className='flex justify-evenly'>
      ...
      <ServiceDisplay setIsModalOpen={setIsModalOpen} service={'Create Your Own Bonds'}/>
      <ServiceDisplay setIsModalOpen={setIsModalOpen} service={'purchase bonds'}/>
    </div>
  )
}
